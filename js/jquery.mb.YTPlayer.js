...
(function (jQuery, ytp) {
	 ...
	 * Copyright (c) 2006 John Resig, Yehuda Katz, JÄ‚Â¶rn Zaefferer, Paul McLanahan
	...
	jQuery.mbYTPlayer = {
		...
		defaults       : {
			...
			addRaster              : false,
			opacity                : 1,
			quality                : "default", //or Ã¢â‚¬Å›smallÃ¢â‚¬Å¥, Ã¢â‚¬Å›mediumÃ¢â‚¬Å¥, Ã¢â‚¬Å›largeÃ¢â‚¬Å¥, Ã¢â‚¬Å›hd720Ã¢â‚¬Å¥, Ã¢â‚¬Å›hd1080Ã¢â‚¬Å¥, Ã¢â‚¬Å›highresÃ¢â‚¬Å¥
			mute                   : false,
			loop                   : true,
			showControls           : true,
